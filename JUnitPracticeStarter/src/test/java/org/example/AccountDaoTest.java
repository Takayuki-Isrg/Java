...
// テストの実行順を設定
// @Orderで設定順にテスト実行する
// @TestMethodOrderを指定しないと実行順は保証されない
...
public class AccountDaoTest {
    ...
    /**
     * 初期化処理
     * JdbcDatabaseTesterの初期化を行う
     */
    @BeforeAll
    public static void setUp() throws Exception {

        // MySQLの設定を反映させるためにgetConnectionメソッドをオーバーライドする
    ...
    public void insertTest() throws Exception {
        ...
        // ID "2_3", PASS "pass2_3" でオブジェクトを生成して、insertするテストを実施する
