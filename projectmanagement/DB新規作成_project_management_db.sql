...
--/****** Object:  Database [project_management_db]    Script Date: 2025/11/01 19:16:24 ******/
CREATE DATABASE [project_management_db]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'project_management_db', FILENAME = N'C:\Users\runti\project_management_db.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'project_management_db_log', FILENAME = N'C:\Users\runti\project_management_db_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [project_management_db] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [project_management_db] SET CURSOR_DEFAULT  GLOBAL 
GO
...
ALTER DATABASE [project_management_db] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [project_management_db] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [project_management_db] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [project_management_db] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [project_management_db] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [project_management_db] SET RECOVERY SIMPLE 
GO

ALTER DATABASE [project_management_db] SET  MULTI_USER 
GO

ALTER DATABASE [project_management_db] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [project_management_db] SET DB_CHAINING OFF 
GO

ALTER DATABASE [project_management_db] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [project_management_db] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [project_management_db] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [project_management_db] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [project_management_db] SET QUERY_STORE = ON
GO

ALTER DATABASE [project_management_db] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
